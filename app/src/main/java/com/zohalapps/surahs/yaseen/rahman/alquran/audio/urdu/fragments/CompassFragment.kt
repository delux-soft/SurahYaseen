...
import com.zohalapps.surahs.yaseen.rahman.alquran.audio.urdu.utils.GPSTracker
import com.zohalapps.surahs.yaseen.rahman.alquran.audio.urdu.utils.MathUtils
import com.zohalapps.surahs.yaseen.rahman.alquran.audio.urdu.viewModel.CompassVM
import com.zohalapps.surahs.yaseen.rahman.alquran.audio.urdu.databinding.FragmentCompassBinding
...
class CompassFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        requestLocation()
        compassBinding.root.doOnPreDraw {
            showAd()
        }
    ...
    private fun showBannerAd(adView: AdView) {
        ...
        compassBinding.qiblaBanner.ad.visibility = View.GONE
        compassBinding.qiblaBanner.advertisement.visibility = View.GONE
        compassBinding.qiblaBanner.bannerContainer.addView(adView)
    }
