package com.zohalapps.surahs.yaseen.rahman.alquran.audio.urdu.customView
...
import com.zohalapps.surahs.yaseen.rahman.alquran.audio.urdu.databinding.CompassViewBinding
...
class CompassView(context: Context, attributes: AttributeSet) :
    ...
    @IdRes
    private val center = ID.compass_rose_image
