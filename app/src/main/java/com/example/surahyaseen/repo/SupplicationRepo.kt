...
import com.example.surahyaseen.activities.drawable
            ...
            listOf(
                ...
                SupplicationModel(
                    ...
                    listOf(
                        ...
                        SupplicationInnerModel(
                            "Eating meal",
                            "بِسْمِ اللَّهِ وَعَلَى بَرَكَةِ اللَّهٍِ",
                ...
                SupplicationModel(
                    "Forgiveness", drawable.forgivness_ic, listOf(
                        SupplicationInnerModel(
                            "For forgiveness",
                            "رَبِّ اغْفرْ لي، وَتُبْ عَلَيَّ، إِنَّكَ أَنْتَ التَّوّابُ الغَفُورُِ",
                            "اے میرے رب مجھے بخش دے اور میری توبہ قبول فرما، تو توبہ قبول کرنے والا اور بخشنے والا ہے۔",
                            "My Lord, forgive me and accept my repentance, you are the Ever-Relenting, the All-Forgiving."
                        ), SupplicationInnerModel(
                            "For forgiveness of sins",
                            "رَبَّنَا وَلَا تُحَمِّلنَا مَا لَا طَاقَةَ لَنَا بِهِۦۖ وَٱعفُ عَنَّا وَٱغفِر لَنَا وَٱرحَمنَآ أَنتَ مَولَىٰنَا فَٱنصُرنَا عَلَى ٱلقَومِ ٱلكَٰفِرِينَُِۡ",
                            "اے پروردگار جتنا بوجھ اٹھانے کی ہم میں طاقت نہیں اتنا ہمارے سر پر نہ رکھیو۔ اور (اے پروردگار) ہمارے گناہوں سے درگزر کر اور ہمیں بخش دے۔ اور ہم پر رحم فرما۔ تو ہی ہمارا مالک ہے اور ہم کو کافروں پر غالب فرما",
                ...
                SupplicationModel(
                    "Namaz", drawable.namaz_ic, listOf(
                        SupplicationInnerModel(
                            "Entering in masjid",
                            "ءاَللّٰہُمَّ افْتَحْ لِیْ اَبْوَابَ رَحْمَتِکَ۔ِ",
                            "اے اللہ !میرے لئے اپنی رحمت کے دروازے کھول دیجئے۔",
                            "O Allah, open the doors of mercy"
                        ),
                        SupplicationInnerModel(
                            "Leaving the masjid",
                            "اَللّٰھُمَّ اِنِّیْ اَسْئَلُکَ مِنْ فَضْلِکَ ۔ِ",
                ...
                SupplicationModel(
                    "Daily Routine", drawable.routine_ic,
                    listOf(
                        SupplicationInnerModel(
                            "Leaving the House",
                        ...
                        SupplicationInnerModel(
                            ...
                            "Prayer for anger",
                            "أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيمَُِِۡ",
                            "میں شیطان مردود سے اللہ عزوجل کی پناہ چاہتا ہوں۔",
                            "I seek the refuge of Allah Almighty from the rejected Shetan"
                        ), SupplicationInnerModel(
                            "Prayer for health, well-being and prosperity",
                            "اَللّٰھُمَّ اغْفِرْلِیْ وَارْحَمْنِیْ وَاھْدِنِیْ وَعَافِنِیْ وَارْزُقْنِیْ۔َُِِۡ",
                            "اے اللہ !مجھے ہدایت پر استقامت نصیب فرمااور مجھے رزق عطا فرما اور مجھے معاف فرما اور مجھ پر رحم فرما",
                            "O Allah! Grant me steadfastness on guidance, bestow sustenance upon me, forgive me, and have mercy upon me."
                        ), SupplicationInnerModel(
                            "When seeing new fruit",
                            "اللَّهُمَّ بَارِكْ لَنَا فِي ثَمَرِنَا وَبَارِكْ لَنَا فِي مَدِينَتِنَا وَبَارِكْ لَنَا فِي صَاعِنَا وَبَارِكْ لَنَا فِي مُدِّنَاَُِِۡ",
                            ...
                            "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ عَبْدِكَ وَرَسُولِكَ وَعَلَى الْمُؤْمِنِينَ وَالْمُؤْمِنَاتِ وَعَلَى الْمُسْلِمِينَ وَالْمُسْلِمَاتَُِِِۡ",
                            ...
                            "O Allah, descend mercy on Muhammad (S.A.W.) who is Your servant and Rasul and all the male and female Moomins and also all the male and female Muslims"
                        )
                    )
                ),
            )
